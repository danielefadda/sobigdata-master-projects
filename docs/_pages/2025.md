...
header_title: "2025 Master projects"
---

<div class="container py-3" id="projects-container">
        {% for image in site.data.home-cards-2025 %}
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <ul>
                ...
                <li>DLAI – Deep Learning-based Artificial Intelligence</li>
                <li>IR – Information Retrieval</li>
                <li>DV – Data Visualization</li>
                <li>DDIDS – Data-Driven Innovation & Data Storytelling</li>
                <li>AITA – Artificial Intelligence Methods For Text Analysis And Web Mining</li>
            </ul>
        </div>
    </div>
</div>
